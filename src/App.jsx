...
// Contract address
const CONTRACT_ADDRESS = "0x33822f4259e901AC7fa60A50087F40a1617ca998"; 
...
export function App( props ) {  
    ...
    async function addChat( name, publicKey ) {
        try {
            ...
            try {
                ...
                alert("Friend already Added! TOO MUCH FRIENDSHIP IS HARMFUL!!");
            }
        } catch(err) {
    ...
    return (
        <Container style={{ padding:"0px", border:"5px solid black" }}>
            ...
            <Row>
                ...
                <Col style={{ "paddingRight":"0px", "borderRight":"5px solid black" }}>
                    <div style={{ "backgroundColor":"#ADE792", "height":"100%", overflowY:"auto" }}>
                          <Row style={{ marginRight:"0px" }}  >
                              <Card style={{ width:'100%', border:"2px solid #016A70",alignSelf:'center', background:"#CEDEBD",marginLeft:"15px" }}>
                                <Card.Header>
                                  Chats
                                </Card.Header>
                              </Card>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px" }}>
                    <div style={{ "backgroundColor":"#0A4D68", "height":"100%" }}>
                        {/* Chat header with refresh button, username and public key are rendered here */}
                        <Row style={{ marginRight:"0px" }}>
                              <Card style={{ width:'100%', alignSelf:'center', margin:"0 0 100px 15px",
                              border:"10px solid #016A70",background:"#CEDEBD" }}>
                                <Card.Header>
                                    { activeChat.friendname } : { activeChat.publicKey }
                                    <Button style={{ background:"#FA9884",float:"right" }} variant="warning" onClick={ () => {
                        ...
                        <div className="SendMessage"  style={{ borderTop:"3px solid black", position:"relative", bottom:"0px", padding:"10px 45px 0 45px", margin:"0 95px 0 0", width:"100%" }}>
                            <Form onSubmit={ (e) => {
                                e.preventDefault();
